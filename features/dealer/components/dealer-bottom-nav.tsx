...
export function DealerBottomNav({ active }: DealerBottomNavProps) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-slate-200 bg-white shadow-[0_-8px_24px_rgba(15,23,42,0.08)] lg:inset-y-0 lg:left-0 lg:right-auto lg:flex lg:w-72 lg:flex-col lg:border-r lg:border-t-0 lg:bg-[#0F2A1A] lg:px-4 lg:py-5 lg:text-white lg:shadow-none">
